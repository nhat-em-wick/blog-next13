        ...
        <section className='flex-col'>
          ...
          <div className='flex items-center gap-4'>
            ...
            <Link rel='nofollow' href='https://www.sanity.io/'>
              ...
              >
                <title>Sanity</title>
                <path opacity='0.7' d='M78.1793 7.99261V21.0028H73.9031V10.2138L78.1793 7.99261Z' fill=''></path>
                <path
                  opacity='0.7'
                ...
                <path
                  ...
                  fill=''
                ></path>
                <path opacity='0.7' d='M43.3705 6.96233V21.0028H39.2927V1.00714L43.3705 6.96233Z' fill=''></path>
                <path
                  opacity='0.5'
                  d='M27.1299 6.18617L20.9511 21.33L17.7731 18.5943L25.1353 1.00714L27.1299 6.18617Z'
                  fill=''
                ></path>
                <path d='M25.1353 1.00714H29.3477L37.1386 21.0028H32.8269L25.1353 1.00714Z' fill=''></path>
                <path d='M44.0012 1.00714L52.9824 14.6682V21.0028L39.2927 1.00714H44.0012Z' fill=''></path>
                <path d='M64.9183 1.00714H60.6739V21.0063H64.9183V1.00714Z' fill=''></path>
                <path d='M73.9031 4.65474H67.37V1.00714H82.5867L84.7443 4.65474H78.1793H73.9031Z' fill=''></path>
                <path opacity='0.5' d='M97.2754 13.4153V21.0028H93.0629V13.4153' fill=''></path>
                <path d='M93.0629 13.4152L100.191 1.00714H104.666L97.2754 13.4152H93.0629Z' fill=''></path>
                <path
                  opacity='0.7'
                ...
                <path
                  ...
                  fill=''
                ></path>
                <path opacity='0.7' d='M52.9824 13.6415V1.00714H57.0602V21.0028H52.9824V13.6415Z' fill=''></path>
                <path
                  opacity='0.7'
