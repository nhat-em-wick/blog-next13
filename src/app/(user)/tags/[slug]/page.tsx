        ...
        <div className='blog-list w-full lg:w-[65%] flex flex-col gap-y-10'>
          ...
          <div className='flex justify-center mt-10'>
            <button
              disabled
              type='button'
              className='text-white cursor-pointer bg-primary hover:bg-primary-dark focus:ring-4 font-medium rounded-full text-md px-5 py-2.5 text-center mr-2 inline-flex items-center'
            >
              <svg
                aria-hidden='true'
                role='status'
